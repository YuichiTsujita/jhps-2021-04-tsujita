...
A monitoring and analysis framework named SIOX proposed in \cite{isc14:kunkel}
automatically suggests and applies performance optimizations,
and it assists locating and diagnosing performance problems.
...
However, our case also focuses on behavior of interconnects
among I/O nodes in the target file system.
...
Interconnects are also one of the key components in HPC systems. Monitoring
data transfers of interconnects has provided a hot-spot of traffic congestion
